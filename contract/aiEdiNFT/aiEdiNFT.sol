...
library Address {
    ...
    function _functionCallWithValue(address target, bytes memory data, uint256 weiValue, string memory errorMessage) private returns (bytes memory) {
        ...
        //sewnt ether to target address ( accounts / contracts )
...
contract TNT721 is Context, TNT165, ITNT721, ITNT721Metadata, ITNT721Enumerable {
    ...
    //pairs of code, both must eixst
    using EnumerableSet for EnumerableSet.UintSet;
    using EnumerableMap for EnumerableMap.UintToAddressMap;
    using EnumerableSet for EnumerableSet.AddressSet;
    mapping (address => EnumerableSet.UintSet) private _holderTokens;
    EnumerableMap.UintToAddressMap private _tokenOwners;
    EnumerableSet.AddressSet private _founderSet ;
    ...
    address private orgFounder =  0xF263633A639B6F5cb89E4f27ED3f3d7cDf099Cd8 ;
    ...
    function safeMint(address to,string memory uri) public virtual payable  {
        require(msg.value >= price , "Not enough $TFUEL sent; check price!");
    ...
    function setPrice(uint256 newPrice) public virtual {
        require( _founderSet.contains( msg.sender ) , "Only founder can set price");
        price = newPrice;
    } 
...
contract CoolNFT is TNT721 {
    constructor (string memory name, string memory symbol) TNT721(name, symbol) {
